  ...
  export const Podium: React.FC<PodiumProps> = ({ topThree, userRank, userPoints }) => {
    ...
    return (
      <div className="grid grid-cols-12 gap-1.5 md:gap-4 mb-6 md:mb-10 items-end">
        {/* Podium - Rank 2 */}
        <div className={`col-span-4 md:col-span-3 bg-white p-2 md:p-4 rounded-lg md:rounded-xl border border-slate-200 flex flex-col items-center text-center shadow-sm relative mt-4 md:mt-8 order-2 md:order-1 self-end ${topThree.length < 2 ? 'invisible' : ''}`}>
          {topThree[1] && (
            <>
        ...
        {/* Podium - Rank 3 */}
        <div className={`col-span-4 md:col-span-3 bg-white p-2 md:p-4 rounded-lg md:rounded-xl border border-slate-200 flex flex-col items-center text-center shadow-sm relative mt-2 md:mt-8 order-3 self-end ${topThree.length < 3 ? 'invisible' : ''}`}>
          {topThree[2] && (
            <>
